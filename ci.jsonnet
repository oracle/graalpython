...
//    local truffleDebugFlags = utils.graalOption("TraceTruffleCompilationDetails", "true"),
  ...
  local coverageGate = commonBuilder + {
      ...
      run +: [
          ...
          ['mx', '--jacoco-whitelist-package', 'com.oracle.graal.python', '--strict-compliance', "--primary", 'gate', '-B=--force-deprecation-as-warning-for-dependencies', '--strict-mode', '--tags', "python-unittest,python-junit", '--jacocout', 'html'],

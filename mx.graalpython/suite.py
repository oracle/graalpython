...
suite = {
    ...
    "graalpython:pythonVersion": "3.13.14",
    "version_from": "sdk",
    "release_from": "sdk",
    ...
    "imports": {
        "suites": [
            ...
            {
                "name": "tools",
                "version": "e5a59769bf1244f1b1ba2af8980cc83f37b392a8",
                "subdir": True,
                "urls": [
                    {"url": "https://github.com/oracle/graal", "kind": "git"},
                ],
    ...
    "projects": {
        ...
        "graalpy-pyconfig": {
            ...
            "cmakeConfig": {
                ...
                "GRAALPY_SYSCONFIG_SOABI": "<graalpy_soabi>",
                "GRAALPY_SYSCONFIG_VERSION": "<py_ver:major_minor>",
            },
            "results": [
                "pyconfig.h",
                ...
                "windows": {
                    "<others>": {
                        ...
                        "results": [
                            ...
                            "bin/modules/_testlimitedcapi<graalpy_ext>",

...
//        Args args = visitArgs(varargslist, defaultArgs, defaultKwArgs);
         ...
         */
        FrameDescriptor fd = scopeEnvironment.getCurrentFrame();
        FunctionRootNode funcRoot = nodeFactory.createFunctionRoot(returnTargetNode.getSourceSection(), funcname, scopeEnvironment.isInGeneratorScope(), fd, returnTargetNode, scopeEnvironment.getExecutionCellSlots(), signature);
...
//        result.assignSourceSection(createSourceSection(node.startOffset, node.endOffset));
    ...
    public ReadNode makeTempLocalVariable() {
        ...
        return ReadLocalVariableNode.create(tempSlot);
    }

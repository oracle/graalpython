...
/**
 * Equivalent of CPython's {@code PyUnicode_EncodeFSDefault}.
 */
@GenerateUncached
...
public abstract class PyUnicodeEncodeFSDefaultNode extends PNodeWithContext {
    ...
    @Specialization
    static byte[] doEncode(Frame frame, TruffleString string,
        ...
        if (isValidNode.execute(string, TS_ENCODING)) {
            ...
            return copyToByteArrayNode.execute(utf8, Encoding.UTF_8);
        }
        TruffleString errors = PythonLanguage.getPythonOS() == PythonOS.PLATFORM_WIN32 ? T_SURROGATEPASS : T_SURROGATEESCAPE;
        return encodeNode.execute(frame, string, T_UTF8, errors);
    }
}

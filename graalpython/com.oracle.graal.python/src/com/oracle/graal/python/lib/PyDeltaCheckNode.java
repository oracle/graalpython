...
/** Equivalent of CPython's {@code PyDelta_Check}. */
@GenerateUncached
@GenerateInline
@GenerateCached(false)
public abstract class PyDeltaCheckNode extends Node {
    public static boolean executeUncached(Object object) {
        return PyDeltaCheckNodeGen.getUncached().execute(null, object);
    }

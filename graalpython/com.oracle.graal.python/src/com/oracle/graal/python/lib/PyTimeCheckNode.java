...
/** Equivalent of CPython's {@code PyTime_Check}. */
@GenerateUncached
@GenerateInline
@GenerateCached(false)
public abstract class PyTimeCheckNode extends Node {
    public static boolean executeUncached(Object object) {
        return PyTimeCheckNodeGen.getUncached().execute(null, object);
    }
    ...
    static boolean doNative(Node inliningTarget, PythonAbstractNativeObject value,
        ...
        return profile.profileObject(inliningTarget, value, com.oracle.graal.python.builtins.PythonBuiltinClassType.PTime);
    }
    ...
    static boolean doForeign(Node inliningTarget, Object value,
        ...
        return interop.isTime(value) && !interop.isDate(value);
    }

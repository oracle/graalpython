...
/** Equivalent of CPython's {@code PyDateTime_Check}. */
@GenerateUncached
@GenerateInline
@GenerateCached(false)
public abstract class PyDateTimeCheckNode extends Node {
    public static boolean executeUncached(Object object) {
        return PyDateTimeCheckNodeGen.getUncached().execute(null, object);
    }
    ...
    static boolean doNative(Node inliningTarget, PythonAbstractNativeObject value,
        ...
        return profile.profileObject(inliningTarget, value, com.oracle.graal.python.builtins.PythonBuiltinClassType.PDateTime);
    }

...
@GenerateUncached
public abstract class PyExceptionGroupInstanceCheckNode extends Node {
    ...
    @Specialization
    static boolean doManaged(@SuppressWarnings("unused") PBaseExceptionGroup exception) {
        return true;
    }
    ...
    static boolean doNative(Node inliningTarget, PythonAbstractNativeObject object,
        ...
        return isSubtypeNode.execute(getClassNode.execute(inliningTarget, object), PythonBuiltinClassType.PBaseExceptionGroup);
    }

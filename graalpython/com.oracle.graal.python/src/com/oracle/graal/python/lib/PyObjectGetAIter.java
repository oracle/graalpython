...
/** Equivalent to PyObject_GetAIter. */
@GenerateUncached
@GenerateCached
@GenerateInline(inlineByDefault = true)
public abstract class PyObjectGetAIter extends Node {
    public static Object executeUncached(Object object) {
        return PyObjectGetAIterNodeGen.getUncached().execute(null, null, object);
    }
    ...
    static Object doGeneric(VirtualFrame frame, Node inliningTarget, Object object,
        ...
        if (slots.am_aiter() == null) {
            throw raiseNode.raise(inliningTarget, PythonBuiltinClassType.TypeError, ErrorMessages.OBJECT_NOT_ASYNC_ITERABLE, object);
        }
        Object asyncIterator = callSlot.execute(frame, inliningTarget, slots.am_aiter(), object);

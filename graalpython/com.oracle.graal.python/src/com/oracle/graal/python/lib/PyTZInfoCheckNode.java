...
import com.oracle.graal.python.builtins.modules.datetime.PTzInfo;
...
/** Equivalent of CPython's {@code PyTZInfo_Check}. */
@GenerateUncached
@GenerateInline
@GenerateCached(false)
public abstract class PyTZInfoCheckNode extends Node {
    public static boolean executeUncached(Object object) {
        return PyTZInfoCheckNodeGen.getUncached().execute(null, object);
    }
    ...
    static boolean doNative(Node inliningTarget, PythonAbstractNativeObject value,
        ...
        return profile.profileObject(inliningTarget, value, com.oracle.graal.python.builtins.PythonBuiltinClassType.PTzInfo);
    }
    ...
    static boolean doForeign(Node inliningTarget, Object value,
        ...
        return interop.isTimeZone(value) && !interop.isDate(value) && !interop.isTime(value);
    }

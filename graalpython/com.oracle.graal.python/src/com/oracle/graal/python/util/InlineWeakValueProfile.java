...
public abstract class InlineWeakValueProfile extends Node {
    ...
    public final <T> T execute(Node inliningTarget, T value) {
        return (T) executeImpl(inliningTarget, value);
    }

    abstract Object executeImpl(Node inliningTarget, Object value);

    @Specialization(guards = "value == cachedValue", limit = "1")
    static Object doCached(Object value,
                    @Cached(value = "value", weak = true) Object cachedValue) {
        return cachedValue;
    }

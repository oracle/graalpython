...
public class PTime extends PythonBuiltinObject {
    ...
    public PTime(Object cls, Shape instanceShape, int hour, int minute, int second, int microsecond, Object tzInfo, int fold) {

...
import com.oracle.graal.python.builtins.modules.hashlib.ShakeDigestObjectBuiltinsClinicProviders.DigestNodeClinicProviderGen;
import com.oracle.graal.python.builtins.modules.hashlib.ShakeDigestObjectBuiltinsClinicProviders.HexdigestNodeClinicProviderGen;
...
@CoreFunctions(extendClasses = {PythonBuiltinClassType.Sha3Shake128Type, PythonBuiltinClassType.Sha3Shake256Type})
public class ShakeDigestObjectBuiltins extends PythonBuiltins {
    ...
    abstract static class DigestNode extends PythonBinaryClinicBuiltinNode {
        @Override
        protected ArgumentClinicProvider getArgumentClinic() {
            return DigestNodeClinicProviderGen.INSTANCE;
        }
    ...
    @GenerateNodeFactory
    @ArgumentClinic(name = "length", conversion = ArgumentClinic.ClinicConversion.Index)
    abstract static class HexdigestNode extends PythonBinaryClinicBuiltinNode {
        @Override
        protected ArgumentClinicProvider getArgumentClinic() {
            return HexdigestNodeClinicProviderGen.INSTANCE;
        }

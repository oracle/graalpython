...
public final class CApiFunction {
    ...
    @CApiBuiltin(name = "_PyByteArray_Start", ret = CHAR_PTR, args = {PyObject}, call = CImpl)
    ...
    @CApiBuiltin(name = "_Py_strhex", ret = PyObject, args = {ConstCharPtrAsTruffleString, CONST_PY_SSIZE_T}, call = CImpl)
    @CApiBuiltin(name = "_Py_strhex_bytes", ret = PyObject, args = {ConstCharPtrAsTruffleString, CONST_PY_SSIZE_T}, call = CImpl)
    @CApiBuiltin(name = "_Py_strhex_with_sep", ret = PyObject, args = {ConstCharPtrAsTruffleString, CONST_PY_SSIZE_T, ConstPyObject, ConstInt}, call = CImpl)
    @CApiBuiltin(name = "_Py_strhex_bytes_with_sep", ret = PyObject, args = {ConstCharPtrAsTruffleString, CONST_PY_SSIZE_T, ConstPyObject, ConstInt}, call = CImpl)
    ...
    @CApiBuiltin(name = "_PyModule_GetDef", ret = PyModuleDef, args = {PyObject}, call = CImpl)
    @CApiBuiltin(name = "_PyModule_GetDict", ret = PyObject, args = {PyObject}, call = CImpl)
    @CApiBuiltin(name = "_PyModule_GetState", ret = Pointer, args = {PyObject}, call = CImpl)
    ...
    @CApiBuiltin(name = "_PyGen_yf", ret = PyObject, args = {PY_GEN_OBJECT}, call = CImpl)
    @CApiBuiltin(name = "PyFile_WriteString", ret = Int, args = {ConstCharPtrAsTruffleString, PyObject}, call = CImpl)
    @CApiBuiltin(name = "PyCFunction_GetClass", ret = PyTypeObject, args = {PyObject}, call = CImpl)
    ...
    @CApiBuiltin(name = "_PyASCIIObject_LENGTH", ret = Py_ssize_t, args = {PyASCIIObject}, call = CImpl)
    @CApiBuiltin(name = "_PyASCIIObject_STATE_ASCII", ret = UNSIGNED_INT, args = {PyASCIIObject}, call = CImpl)
    @CApiBuiltin(name = "_PyASCIIObject_STATE_COMPACT", ret = UNSIGNED_INT, args = {PyASCIIObject}, call = CImpl)
    @CApiBuiltin(name = "_PyASCIIObject_STATE_KIND", ret = UNSIGNED_INT, args = {PyASCIIObject}, call = CImpl)
    @CApiBuiltin(name = "_PyASCIIObject_STATE_READY", ret = UNSIGNED_INT, args = {PyASCIIObject}, call = CImpl)
    @CApiBuiltin(name = "_PyASCIIObject_WSTR", ret = WCHAR_T_PTR, args = {PyASCIIObject}, call = CImpl)
    ...
    @CApiBuiltin(name = "_PyUnicode_get_wstr_length", ret = Py_ssize_t, args = {PyObject}, call = CImpl)
    ...
    @CApiBuiltin(name = "PyVectorcall_Call", ret = PyObject, args = {PyObject, PyObject, PyObject}, call = CImpl)
    @CApiBuiltin(name = "_PyObject_CallMethodIdObjArgs", ret = PyObject, args = {PyObject, _PY_IDENTIFIER_PTR, VARARGS}, call = CImpl)
    @CApiBuiltin(name = "_Py_dg_dtoa", ret = CHAR_PTR, args = {Double, Int, Int, INT_LIST, INT_LIST, CHAR_PTR_LIST}, call = CImpl)
    @CApiBuiltin(name = "_Py_dg_freedtoa", ret = Void, args = {CHAR_PTR}, call = CImpl)

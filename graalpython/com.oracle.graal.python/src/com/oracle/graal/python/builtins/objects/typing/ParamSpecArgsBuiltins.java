...
import static com.oracle.graal.python.nodes.ErrorMessages.CANNOT_SUBCLASS_AN_INSTANCE_OF_PARAMSPEC_ARGS;
...
public final class ParamSpecArgsBuiltins extends PythonBuiltins {
    ...
    @SlotSignature(name = J_PARAM_SPEC_ARGS, minNumOfPositionalArgs = 2, parameterNames = {"$cls", "origin"})
    @GenerateNodeFactory
    abstract static class ParamSpecArgsNode extends PythonBinaryBuiltinNode {
        ...
        static PParamSpecArgs newParamSpecArgs(Object cls, Object origin,
            ...
            return PFactory.createParamSpecArgs(cls, getInstanceShape.execute(cls), origin);
        }
    }
    ...
    abstract static class ReprNode extends PythonUnaryBuiltinNode {
        private static final TruffleString T_ARGS = tsLiteral(".args");
    ...
    abstract static class GetOriginNameHelperNode extends Node {
        abstract TruffleString execute(VirtualFrame frame, Node inliningTarget, Object origin);
        ...
        @Fallback
        static TruffleString doGeneric(VirtualFrame frame, Node inliningTarget, Object origin,
                        @Cached PyObjectReprAsTruffleStringNode reprNode) {
            return reprNode.execute(frame, inliningTarget, origin);
        }
    }
}

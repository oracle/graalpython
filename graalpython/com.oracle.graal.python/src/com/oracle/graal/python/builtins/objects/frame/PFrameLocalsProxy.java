...
/** A live mapping view of the local slots in a materialized {@link BytecodeFrame}. */
public final class PFrameLocalsProxy extends PythonBuiltinObject {
    private final PFrame frame;
    private final BytecodeFrame bytecodeFrame;

    public PFrameLocalsProxy(Object cls, Shape shape, PFrame frame) {
        super(cls, shape);
        this.frame = frame;
        this.bytecodeFrame = frame.getBytecodeFrame();
    }

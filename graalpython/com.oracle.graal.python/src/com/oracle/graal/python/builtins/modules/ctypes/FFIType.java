...
public final class FFIType {
    ...
    public static final FFIType ffi_type_float = new FFIType(Float.BYTES, Float.BYTES, FFI_TYPES.FFI_TYPE_FLOAT, ffi_type_float_array);
    ...
    public enum FFI_TYPES {
        ...
        FFI_TYPE_OBJECT(tsLiteral("OBJECT"), Long.BYTES), // `TruffleObject`
    ...
    enum FieldDesc {
        ...
        U('U', FieldSet.U_set, FieldGet.U_get, WCHAR_T_SIZE == 2? ffi_type_sint16_array: ffi_type_sint32_array), // Unicode String CTYPES_UNICODE
        Z('Z', FieldSet.Z_set, FieldGet.Z_get, WCHAR_T_SIZE == 2? ffi_type_sint16_array: ffi_type_sint32_array), // Unicode String wchar_t

...
public enum NativeCAPISymbol implements NativeCExtSymbol {
    ...
    FUN_PY_TRUFFLE_ARG_GET_BUFFER("PyTruffleArg_GetBuffer", Int, PyObject, Pointer),
    FUN_PY_TRUFFLE_ARG_GET_BUFFER_WRITABLE("PyTruffleArg_GetBufferWritable", Int, PyObject, Pointer),
    FUN_PY_TRUFFLE_ARG_CONVERT_BUFFER("PyTruffleArg_ConvertBuffer", Py_ssize_t, PyObject, Pointer),

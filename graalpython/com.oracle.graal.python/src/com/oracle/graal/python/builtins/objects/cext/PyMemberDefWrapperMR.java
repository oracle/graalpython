...
import com.oracle.graal.python.builtins.objects.cext.PyMemberDefWrapperMRFactory.ReadFieldNodeGen;
import com.oracle.graal.python.builtins.objects.cext.PyMemberDefWrapperMRFactory.WriteFieldNodeGen;
...
@MessageResolution(receiverType = PyMemberDefWrapper.class)
public class PyMemberDefWrapperMR {
    @Resolve(message = "READ")
    abstract static class ReadNode extends Node {
        @Child private ReadFieldNode readFieldNode = ReadFieldNodeGen.create();

        public Object access(PyMemberDefWrapper object, String key) {
    ...
    abstract static class WriteNode extends Node {
        ...
        public int access(PyMemberDefWrapper object, String key, Object value) {
    ...
    abstract static class WriteFieldNode extends Node {
        ...
        void getDoc(PythonObject object, @SuppressWarnings("unused") String key, Object value,
            ...
            setAttrNode.execute(object, key, getFromCharPointer().execute(value));
        }
    }
}

...
public final class ImportErrorBuiltins extends PythonBuiltins {
    ...
    public abstract static class ImportErrorReduceNode extends PythonUnaryBuiltinNode {
        private Object getState(PBaseException self, GetDictIfExistsNode getDictIfExistsNode, HashingStorageSetItem setHashingStorageItem, HashingStorageLibrary hashlib,
        ...
        Object reduce(VirtualFrame frame, PBaseException self,
            ...
            Object state = getState(self, getDictIfExistsNode, setHashingStorageItem, hashlib, attrNode);
            if (state == PNone.NONE) {

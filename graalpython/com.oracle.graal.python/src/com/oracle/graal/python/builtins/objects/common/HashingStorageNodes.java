...
public abstract class HashingStorageNodes {
    ...
    public abstract static class ContainsKeyNode extends DictStorageBaseNode {
        ...
        @Specialization(guards = "lib.isHashable(key)")
    ...
    public abstract static class SetItemNode extends SetItemBaseNode {
        ...
        @Specialization(guards = {"!isJavaString(key)", "lib.isHashable(key)"})
        @SuppressWarnings("try")
    ...
    public abstract static class GetItemNode extends DictStorageBaseNode {
        ...
        @Specialization(guards = {"!isString(key)", "lib.isHashable(key)"})
        ...
        // non-string keys
        @Specialization(guards = {"!isString(key)", "lib.isHashable(key)", "!isPythonObjectHybridStorage(s)"})
        @SuppressWarnings("unused")

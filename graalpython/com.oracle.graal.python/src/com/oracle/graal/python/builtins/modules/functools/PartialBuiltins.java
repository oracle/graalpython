...
public final class PartialBuiltins extends PythonBuiltins {
    ...
    public static final TpSlots SLOTS = PartialBuiltinsSlotsGen.SLOTS;
    ...
    @Builtin(name = J___NEW__, raiseErrorName = "partial", minNumOfPositionalArgs = 1, takesVarArgs = true, takesVarKeywordArgs = true, constructsClass = PythonBuiltinClassType.PPartial)
    @GenerateNodeFactory

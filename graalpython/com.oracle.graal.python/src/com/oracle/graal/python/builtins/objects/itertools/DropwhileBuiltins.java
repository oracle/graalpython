...
public final class DropwhileBuiltins extends PythonBuiltins {
    ...
    @Builtin(name = J___NEW__, raiseErrorName = "dropwhile", minNumOfPositionalArgs = 1, takesVarArgs = true, takesVarKeywordArgs = true, constructsClass = PythonBuiltinClassType.PDropwhile)
    @GenerateNodeFactory

...
public class PHostInteropBehavior extends PythonBuiltinObject {
    ...
    public PHostInteropBehavior(Object cls, Shape instanceShape, PythonAbstractObject receiver, Object[] args) {
        super(cls, instanceShape);
        this.receiver = receiver;
        assert args.length == HostInteropBehaviorArg.values().length;
        this.args = args;
    }

    public Object getCallable(HostInteropBehaviorArg arg) {

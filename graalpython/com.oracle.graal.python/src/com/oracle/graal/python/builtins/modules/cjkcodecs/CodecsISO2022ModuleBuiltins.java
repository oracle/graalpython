...
public final class CodecsISO2022ModuleBuiltins extends PythonBuiltins {
    ...
    protected List<? extends NodeFactory<? extends PythonBuiltinBaseNode>> getNodeFactories() {
        return CodecsISO2022ModuleBuiltinsFactory.getFactories();
    }

    private static final MultibyteCodec[] CODEC_LIST = new MultibyteCodec[7];
    // #define ISO2022_CODEC(variation) { \
    // "iso2022_" #variation, &iso2022_##variation##_config, iso2022_codec_init,
    ...
    public void postInitialize(Python3Core core) {
        ...
        int i = 0;
        registerCodec("iso2022_kr", i++, CodecType.ISO2022, -1, null, null, CODEC_LIST);

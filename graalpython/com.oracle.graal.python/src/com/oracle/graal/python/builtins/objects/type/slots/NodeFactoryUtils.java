...
public class NodeFactoryUtils {
    /**
     * Convenience base class to reduce boilerplate when implementing {@link NodeFactory}.
     */
    public abstract static class NodeFactoryBase<T> implements NodeFactory<T> {
        @Override
        ...
        public static <K> Class<?> getWrappedNodeClass(NodeFactory<K> factory) {
            if (factory instanceof NodeFactoryBase<K> nfb) {

...
// Auto generated by gen_native_cfg.py at 2026-09-04 10:44:31.642954
// on Linux yuyuko 7.1.12-200.fc44.x86_64 #1 SMP PREEMPT_DYNAMIC Fri Aug 28 14:00:18 UTC 2026 x86_64
class PosixConstantsLinux {
    ...
    static void getConstants(PosixConstants.Registry constants) {
        ...
        constants.put("POLLWRNORM", 0x00000100);
        constants.put("POLLWRBAND", 0x00000200);
        constants.put("POLLMSG", 0x00000400);
        ...
        constants.put("_SC_HOST_NAME_MAX", 180);
        constants.put("_SC_LOGIN_NAME_MAX", 71);
        constants.put("_SC_NGROUPS_MAX", 3);
        constants.put("_SC_CLK_TCK", 2);
        constants.put("_SC_OPEN_MAX", 4);
        constants.put("_SC_PAGESIZE", 30);
        constants.put("_SC_PAGE_SIZE", 30);
        constants.put("_SC_RE_DUP_MAX", 44);
        constants.put("_SC_STREAM_MAX", 5);
        constants.put("_SC_SYMLOOP_MAX", 173);
        constants.put("_SC_TTY_NAME_MAX", 72);
        constants.put("_SC_TZNAME_MAX", 6);
        constants.put("_SC_VERSION", 29);
        constants.put("_SC_BC_BASE_MAX", 36);
        constants.put("_SC_BC_DIM_MAX", 37);
        constants.put("_SC_BC_SCALE_MAX", 38);
        constants.put("_SC_BC_STRING_MAX", 39);
        constants.put("_SC_COLL_WEIGHTS_MAX", 40);
        constants.put("_SC_EXPR_NEST_MAX", 42);
        constants.put("_SC_LINE_MAX", 43);
        constants.put("_SC_2_VERSION", 46);
        constants.put("_SC_2_C_DEV", 48);
        constants.put("_SC_2_FORT_DEV", 49);
        constants.put("_SC_2_FORT_RUN", 50);
        constants.put("_SC_2_LOCALEDEF", 52);
        constants.put("_SC_2_SW_DEV", 51);
        constants.put("_SC_SEM_NSEMS_MAX", 32);
        constants.put("_SC_PHYS_PAGES", 85);
        constants.put("_SC_AVPHYS_PAGES", 86);

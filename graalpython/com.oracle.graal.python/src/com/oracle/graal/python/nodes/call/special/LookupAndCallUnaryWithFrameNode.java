...
public abstract class LookupAndCallUnaryWithFrameNode extends Node {
    ...
    public static LookupAndCallUnaryWithFrameNode create(String name) {
        return LookupAndCallUnaryWithFrameNodeGen.create(name, null);
    }

    public static LookupAndCallUnaryWithFrameNode create(String name, Supplier<NoAttributeHandler> handlerFactory) {
        return LookupAndCallUnaryWithFrameNodeGen.create(name, handlerFactory);
    }

    LookupAndCallUnaryWithFrameNode(String name, Supplier<NoAttributeHandler> handlerFactory) {
        this.name = name;
        this.handlerFactory = handlerFactory;
    }

    protected PythonUnaryBuiltinWithFrameNode getBuiltin(Object receiver) {
        ...
        if (attribute instanceof PBuiltinFunction) {
            ...
            if (PythonUnaryBuiltinWithFrameNode.class.isAssignableFrom(builtinFunction.getBuiltinNodeFactory().getNodeClass())) {
                return (PythonUnaryBuiltinWithFrameNode) builtinFunction.getBuiltinNodeFactory().createNode();
            }
        }
        return null;
    }
    ...
    int callInt(VirtualFrame frame, int receiver,
                    @Cached("getBuiltin(receiver)") PythonUnaryBuiltinWithFrameNode function) throws UnexpectedResultException {
    ...
    Object callObject(VirtualFrame frame, int receiver,
                    @Cached("getBuiltin(receiver)") PythonUnaryBuiltinWithFrameNode function) {
    ...
    Object callObject(VirtualFrame frame, Object receiver,
                    ...
                    @Cached("create()") CallUnaryMethodWithFrameNode dispatchNode) {

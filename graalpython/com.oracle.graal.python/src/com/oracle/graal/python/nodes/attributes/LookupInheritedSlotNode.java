 ...
 * Unlike {@link LookupInheritedAttributeNode}, this node may return
 * {@link com.oracle.graal.python.builtins.objects.function.BuiltinMethodDescriptor}.
 * 
 * @see SpecialMethodSlot
 */
public final class LookupInheritedSlotNode extends PNodeWithContext {

    @Child private LookupCallableSlotInMRONode lookupInMRONode;
    @Child private GetClassNode getClassNode = GetClassNode.create();

    private LookupInheritedSlotNode(SpecialMethodSlot slot) {
        lookupInMRONode = LookupCallableSlotInMRONode.create(slot);
    }

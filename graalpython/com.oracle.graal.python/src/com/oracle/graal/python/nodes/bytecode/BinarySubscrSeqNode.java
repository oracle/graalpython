...
public class BinarySubscrSeqNode extends Node {
    ...
    @Child SequenceStorageNodes.GetItemNode getItemNode = SequenceStorageNodes.GetItemNode.create();
    ...
    public static BinarySubscrSeqNode create() {
        return new BinarySubscrSeqNode();
    }

    public static boolean accepts(Object object) {
        return object instanceof PSequence && !(object instanceof PString);
    }
}

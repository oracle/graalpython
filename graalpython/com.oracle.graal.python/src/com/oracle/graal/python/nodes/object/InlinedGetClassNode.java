...
public abstract class InlinedGetClassNode extends PNodeWithContext {
    ...
    static Object getPythonObject(PythonObject object,
                    @Shared("obj") @Cached(inline = false) GetPythonObjectClassNode getClassNode) {
        return getClassNode.execute(null, object);
    }

    @Specialization
    static Object getPythonNativeObject(PythonAbstractNativeObject object,
                    @Shared("obj") @Cached(inline = false) GetPythonObjectClassNode getClassNode) {
        return getClassNode.execute(null, object);
    }

...
public abstract class PythonQuinaryClinicBuiltinNode extends PythonQuinaryBuiltinNode {
    ...
    protected Object castWithNode(ArgumentClinicProvider clinic, VirtualFrame frame, int argIndex, Object value) {
        ...
        if (castNodes == null) {
            ...
            castNodes = new ArgumentCastNode[5];
        }
    ...
    public Object call(VirtualFrame frame, Object arg, Object arg2, Object arg3, Object arg4, Object arg5) {
        ...
        return super.call(frame, cast(clinic, frame, 0, arg), cast(clinic, frame, 1, arg2), cast(clinic, frame, 2, arg3), cast(clinic, frame, 3, arg4), cast(clinic, frame, 4, arg5));
    }
}

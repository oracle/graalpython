...
public abstract class MakeGenericNode extends PNodeWithContext {
    ...
    static int makeGeneric(VirtualFrame frame, int initialStackTop,
        ...
        PTuple params = (PTuple) frame.getObject(stackTop);
    ...
    public static MakeGenericNode create() {
        return MakeGenericNodeGen.create();
    }

    public static MakeGenericNode getUncached() {
        return MakeGenericNodeGen.getUncached();
    }
}

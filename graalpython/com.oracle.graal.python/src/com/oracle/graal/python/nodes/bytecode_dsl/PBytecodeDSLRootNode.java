...
public abstract class PBytecodeDSLRootNode extends PRootNode implements BytecodeRootNode {
    ...
    public static final class ITrueDiv {
        ...
        public static double doII(int left, int right) throws OverflowException {
            return PyNumberTrueDivideNode.doII(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doLD(int left, double right) throws OverflowException {
            return PyNumberTrueDivideNode.doID(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doDL(double left, int right) throws OverflowException {
            return PyNumberTrueDivideNode.doDI(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doDD(double left, double right) throws OverflowException {
            return PyNumberTrueDivideNode.doDD(left, right);
        }
    ...
    public static final class IFloorDiv {
        @Specialization(rewriteOn = OverflowException.class)
        public static int doII(int left, int right) throws OverflowException {
            return PyNumberFloorDivideNode.doII(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static long doLL(long left, long right) throws OverflowException {
            return PyNumberFloorDivideNode.doLL(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doDL(double left, int right) throws OverflowException {
            return PyNumberFloorDivideNode.doDI(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doDD(double left, double right) throws OverflowException {
            return PyNumberFloorDivideNode.doDD(left, right);
        }

        @Specialization(rewriteOn = OverflowException.class)
        public static double doLD(int left, double right) throws OverflowException {
            return PyNumberFloorDivideNode.doID(left, right);
        }
    ...
    public static final class IMod {
        @Specialization(rewriteOn = ArithmeticException.class)
        public static int doII(int left, int right) {
            return PyNumberRemainderNode.doII(left, right);
        }

        @Specialization(rewriteOn = ArithmeticException.class)
        public static long doLL(long left, long right) {
            return PyNumberRemainderNode.doLL(left, right);
        }
    ...
    public static final class MakeDict {
        // TODO: split to empty dict and non-empty dict created directly from hashmap storage
        @Specialization
        @ExplodeLoop

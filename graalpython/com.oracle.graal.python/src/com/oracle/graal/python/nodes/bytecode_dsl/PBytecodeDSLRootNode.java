...
import static com.oracle.graal.python.builtins.objects.type.slots.TpSlotIterNext.ITERATOR_EXHAUSTED;
...
public abstract class PBytecodeDSLRootNode extends PRootNode implements BytecodeRootNode {
    ...
    static class IteratorExhausted extends RuntimeException {
        // TODO: replace with IteratorExhausted from PR-3724 once that PR is merged
    }

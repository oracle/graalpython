...
public abstract class HostInteropMethodNames {
    ...
    public static final String J_GET_ARRAY_ELEMENT = "get_array_element";
    public static final TruffleString T_GET_ARRAY_ELEMENT = tsLiteral(J_GET_ARRAY_ELEMENT);
    ...
    public static final String J_SET_ARRAY_ELEMENT = "set_array_element";
    public static final TruffleString T_SET_ARRAY_ELEMENT = tsLiteral(J_SET_ARRAY_ELEMENT);
    ...
    public static final String J_GET_HASH_VALUE = "get_hash_value";
    public static final TruffleString T_GET_HASH_VALUE = tsLiteral(J_GET_HASH_VALUE);
    public static final String J_GET_HASH_VALUE_OR_DEFAULT = "get_hash_value_or_default";
    public static final TruffleString T_GET_HASH_VALUE_OR_DEFAULT = tsLiteral(J_GET_HASH_VALUE_OR_DEFAULT);
    ...
    public static final String J_HAS_HASH_ENTRY = "has_hash_entry";
    public static final TruffleString T_HAS_HASH_ENTRY = tsLiteral(J_HAS_HASH_ENTRY);
    public static final String J_PUT_HASH_ENTRY = "put_hash_entry";
    public static final TruffleString T_PUT_HASH_ENTRY = tsLiteral(J_PUT_HASH_ENTRY);

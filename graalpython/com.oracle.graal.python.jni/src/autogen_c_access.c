...
_HPy_HIDDEN int fill_c_field_offsets(int32_t *cfield_offsets)
{
    ...
    cfield_offsets[40] = (int32_t) offsetof(PyGetSetDef, closure);
    cfield_offsets[41] = (int32_t) offsetof(PyMemberDef, name);
    cfield_offsets[42] = (int32_t) offsetof(PyMemberDef, type);
    cfield_offsets[43] = (int32_t) offsetof(PyMemberDef, offset);
    cfield_offsets[44] = (int32_t) offsetof(PyMemberDef, flags);
    cfield_offsets[45] = (int32_t) offsetof(PyMemberDef, doc);
    cfield_offsets[46] = (int32_t) offsetof(HPy_buffer, buf);
    cfield_offsets[47] = (int32_t) offsetof(HPy_buffer, obj);
    cfield_offsets[48] = (int32_t) offsetof(HPy_buffer, len);
    cfield_offsets[49] = (int32_t) offsetof(HPy_buffer, itemsize);
    cfield_offsets[50] = (int32_t) offsetof(HPy_buffer, readonly);
    cfield_offsets[51] = (int32_t) offsetof(HPy_buffer, ndim);
    cfield_offsets[52] = (int32_t) offsetof(HPy_buffer, format);
    cfield_offsets[53] = (int32_t) offsetof(HPy_buffer, shape);
    cfield_offsets[54] = (int32_t) offsetof(HPy_buffer, strides);
    cfield_offsets[55] = (int32_t) offsetof(HPy_buffer, suboffsets);

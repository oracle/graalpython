...
public class VFSUtilsTest {
    ...
    private static final String NEW_PACKAGE_OR_VERSION_ERROR = "requirements %s inconsistent with packages %s";
    private static final String PACKAGE_REMOVED_ERROR = "packages changed in requirements file %s, current packages %s, previous packages %s";
    ...
    public void installAndFreeze() throws IOException {
        ...
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains(String.format(NEW_PACKAGE_OR_VERSION_ERROR, requirements, "tiny-tiny==0.2")));
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.1", "charset-normalizer", "idna", "urllib3", "certifi");
        checkVenvContentsFile(contents, "0.1", "requests==2.32.1");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains(String.format(NEW_PACKAGE_OR_VERSION_ERROR, requirements, "requests==2.32.2")));
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.1", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkVenvContentsFile(contents, "0.1", "requests==2.32.1", "tiny-tiny==0.2");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains(String.format(PACKAGE_REMOVED_ERROR, requirements, "tiny-tiny==0.2", "requests==2.32.2, tiny-tiny==0.2")));
        log.clearOutput();
    ...
    public void packageConsistency() throws Exception {
        ...
        assertTrue(log.getOutput().contains(String.format(NEW_PACKAGE_OR_VERSION_ERROR, requirements, "pkg1==1")));
        log.clearOutput();
        ...
        assertTrue(log.getOutput().contains(String.format(NEW_PACKAGE_OR_VERSION_ERROR, requirements, "pkg2==1")));
        log.clearOutput();
        ...
        assertTrue(log.getOutput().contains(String.format(NEW_PACKAGE_OR_VERSION_ERROR, requirements, "pkg2==2")));
        log.clearOutput();
    ...
    private static void callPackageConsistencyCheck(TestLog log, List<String> requirementsList, Path requirements, String... packages)
        ...
        m.setAccessible(true);
        m.invoke(VFSUtils.class, Arrays.asList(packages), requirementsList, requirements, NEW_PACKAGE_OR_VERSION_ERROR, log);
    }
    ...
    private static void createVenv(Path venvDir, String graalPyVersion, TestLog log, Path requirements, String... packages) throws IOException {
        EmbeddingTestUtils.createVenv(venvDir, graalPyVersion, log, requirements, NEW_PACKAGE_OR_VERSION_ERROR, WRONG_PKG_VERSION_ERROR, MISSING_REQUIREMENTS_FILE_WARNING, PACKAGE_REMOVED_ERROR,
                        packages);
    }

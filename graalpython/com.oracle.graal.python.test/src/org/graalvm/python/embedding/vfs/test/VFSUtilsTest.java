...
public class VFSUtilsTest {
    ...
    private static final String PACKAGE_WAS_REMOVED = "A package with unknown dependencies was removed since last install, setting up a clean venv";
    ...
    private static final String PACKAGES_CHANGED_ERROR = "packages changed in requirements file %s, current packages %s, previous packages %s";
    ...
    /**
     * tests scenarios without requirements file logic available, but not used
     *
     * - packages declared only in plugin config - requirement file path is provided, but does not
     * exist
     */
    @Test
    ...
    /**
     * tests scenarios without requirements file logic - e.g. when called from jbang
     *
     * - packages declared only in plugin config - and requirement file path is not provided
     */
    @Test
    public void withoutRequirementsFile() throws IOException {
        TestLog log = new TestLog();
        Path tmpDir = Files.createTempDirectory("withoutRequirementsFile");
        Path venvDir = tmpDir.resolve("venv");
        Path contents = venvDir.resolve("contents");
        deleteDirOnShutdown(tmpDir);
    ...
    public void onlyRequirementsFile() throws IOException {
        TestLog log = new TestLog();
        Path tmpDir = Files.createTempDirectory("onlyRequirementsFile");
        Path venvDir = tmpDir.resolve("venv");
        Path contents = venvDir.resolve("contents");
        deleteDirOnShutdown(tmpDir);
    ...
    /**
     * requirement file exists but is empty
     */
    @Test
    public void emptyRequirements() throws IOException {
        TestLog log = new TestLog();
        Path tmpDir = Files.createTempDirectory("emptyRequirements");
        Path venvDir = tmpDir.resolve("venv");
        deleteDirOnShutdown(tmpDir);
    ...
    public void installAndFreeze() throws IOException {
        TestLog log = new TestLog();
        Path tmpDir = Files.createTempDirectory("installAndFreeze");
        Path venvDir = tmpDir.resolve("venv");
        Path contents = venvDir.resolve("contents");
        deleteDirOnShutdown(tmpDir);
        ...
        // we get the missing requirements file warning
        createVenv(venvDir, "0.1", log, requirements, "requests");
        assertTrue(Files.exists(venvDir));
        checkVenvCreate(log.getOutput(), true);
        ...
        checkException(IOException.class, () -> freeze(venvDir, requirements, log, "requests"));
        assertFalse(Files.exists(requirements));
        assertTrue(log.getOutput().contains(String.format(WRONG_PKG_VERSION_ERROR, "requests")));
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        // freeze requirements with version - ok
        freeze(venvDir, requirements, log, "requests==2.32.2");
        checkRequirementsFile(requirements, "requests==2.32.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkVenvContentsFile(contents, "0.1", "requests==2.32.2");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();

        // reinstall without exact version declared - fails
        checkException(IOException.class, () -> createVenv(venvDir, "0.1", log, requirements, "requests"));
        checkVenvCreate(log.getOutput(), false);
        assertTrue(log.getOutput().contains(String.format(WRONG_PKG_VERSION_ERROR, "requests")));
        assertFalse(log.getOutput().contains("pip install"));
        ...
        delete(venvDir);
        createVenv(venvDir, "0.1", log, requirements, "requests==2.32.2");
        assertTrue(Files.exists(venvDir));
        checkVenvCreate(log.getOutput(), true);
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkVenvContentsFile(contents, "0.1", "requests==2.32.2");
        ...
        createVenv(venvDir, "0.1", log, requirements, "requests==2.32.1");
        ...
        log.clearOutput();
        // freeze requirements
        freeze(venvDir, requirements, log, "requests==2.32.1");
        checkRequirementsFile(requirements, "requests==2.32.1", "charset-normalizer", "idna", "urllib3", "certifi");
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.1", "charset-normalizer", "idna", "urllib3", "certifi");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        checkException(IOException.class, () -> createVenv(venvDir, "0.1", log, requirements, "requests==2.32.1", "tiny-tiny==0.2"));
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        ...
        Files.delete(requirements);
        createVenv(venvDir, "0.1", log, requirements, "requests==2.32.1", "tiny-tiny==0.2");
        checkVenvCreate(log.getOutput(), false);
        assertTrue(log.getOutput().contains("pip install"));
        ...
        log.clearOutput();
        // freeze requirements
        freeze(venvDir, requirements, log, "requests==2.32.1", "tiny-tiny==0.2");
        checkRequirementsFile(requirements, "requests==2.32.1", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.1", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        checkException(IOException.class, () -> createVenv(venvDir, "0.1", log, requirements, "requests==2.32.2", "tiny-tiny==0.2"));
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains(String.format(INCONSISTENT_PKGS_ERROR, requirements, "requests==2.32.2")));
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.1", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkVenvContentsFile(contents, "0.1", "requests==2.32.1", "tiny-tiny==0.2");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        Files.delete(requirements);
        createVenv(venvDir, "0.1", log, requirements, "requests==2.32.2", "tiny-tiny==0.2");
        // we changed version from 2.32.2 to 2.32.1, we do not know if the prev version did not
        // leave
        // any transitive deps, so the venv is deleted and created again
        checkVenvCreate(log.getOutput(), true);
        ...
        assertTrue(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        // freeze requirements with new requests version
        freeze(venvDir, requirements, log, "requests==2.32.2", "tiny-tiny==0.2");
        checkInstalledPackages(venvDir.resolve("installed.txt"), "requests==2.32.2", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        checkRequirementsFile(requirements, "requests==2.32.2", "tiny-tiny==0.2", "charset-normalizer", "idna", "urllib3", "certifi");
        assertFalse(log.getOutput().contains(MISSING_REQUIREMENTS_FILE_WARNING));
        log.clearOutput();
        ...
        // remove requests from packages list - fails because it is still in requirements
        checkException(IOException.class, () -> createVenv(venvDir, "0.1", log, requirements, "tiny-tiny==0.2"));
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains(String.format(PACKAGES_CHANGED_ERROR, requirements, "tiny-tiny==0.2", "requests==2.32.2, tiny-tiny==0.2")));
        log.clearOutput();
        // freeze requirements only with tiny-tiny
        freeze(venvDir, requirements, log, "tiny-tiny==0.2");
        checkVenvCreate(log.getOutput(), true);
        checkRequirementsFile(requirements, "tiny-tiny==0.2");
        ...
        log.clearOutput();
        // try again
        createVenv(venvDir, "0.1", log, requirements, "tiny-tiny==0.2");
        checkVenvCreate(log.getOutput(), false);
        assertFalse(log.getOutput().contains("pip install"));
        assertTrue(log.getOutput().contains("Virtual environment is up to date with requirements file"));
        log.clearOutput();

        // reinstall with new graalpy version
        createVenv(venvDir, "0.2", log, requirements, "tiny-tiny==0.2");
        checkVenvCreate(log.getOutput(), true);
    ...
    @Test
    public void invalidVersionFormatTest() throws NoSuchMethodException {
        TestLog log = new TestLog();
    ...
    private static void checkWrongPkgVersionFormat(String pkg, TestLog log) throws NoSuchMethodException {
        Method m = VFSUtils.class.getDeclaredMethod("checkVersionFormat", List.class, String.class, BuildToolLog.class);
        m.setAccessible(true);
        checkException(IOException.class, () -> m.invoke(VFSUtils.class, Arrays.asList(pkg), WRONG_PKG_VERSION_ERROR, log));
    ...
    public void packageConsistency() throws Exception {
        ...
        Path tmpDir = Files.createTempDirectory("packageConsistency");
        deleteDirOnShutdown(tmpDir);
        Path requirements = tmpDir.resolve("requirements.txt");
        Files.createFile(requirements);
    ...
    private static void callPackageConsistencyCheck(TestLog log, List<String> requirementsList, Path requirements, String... packages)
        ...
        Method m = VFSUtils.class.getDeclaredMethod("checkPluginPackagesInRequirementsFile", List.class, List.class, Path.class, String.class, BuildToolLog.class);
        m.setAccessible(true);
        m.invoke(VFSUtils.class, Arrays.asList(packages), requirementsList, requirements, INCONSISTENT_PKGS_ERROR, log);
    }
    ...
    public void packageRemoved() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException {
        ...
        assertFalse(callPackageRemoved(venvDir, Collections.emptyList(), Collections.emptyList(), Collections.emptyList()));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1"), Collections.emptyList(), Collections.emptyList()));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1", "pkg2"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1", "pkg2"), Arrays.asList("pkg1", "pkg2"), Arrays.asList("pkg1==1", "pkg2==1")));

        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1=="), Arrays.asList("pkg1=="), Arrays.asList("pkg1==1")));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("==pkg1"), Arrays.asList("==pkg1"), Arrays.asList("pkg1==1")));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1==1"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));
        assertFalse(callPackageRemoved(venvDir, Arrays.asList("pkg1"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));

        assertTrue(callPackageRemoved(venvDir, Collections.emptyList(), Arrays.asList("pkg"), Arrays.asList("pkg==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg2"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1"), Arrays.asList("pkg1", "pkg2"), Arrays.asList("pkg1==1", "pkg2==1")));

        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1"), Arrays.asList("pkg1=="), Arrays.asList("pkg1==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1=="), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("==pkg1"), Arrays.asList("pkg1"), Arrays.asList("pkg1==1")));

        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1==2"), Arrays.asList("pkg1==1"), Arrays.asList("pkg1==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1==2"), Arrays.asList("pkg1==1", "pkg2==1"), Arrays.asList("pkg1==1", "pkg2==1")));
        assertTrue(callPackageRemoved(venvDir, Arrays.asList("pkg1==2"), Arrays.asList("pkg1", "pkg2"), Arrays.asList("pkg1==1", "pkg2==1")));
    }

    private static boolean callPackageRemoved(Path venvDir, List<String> packages, List<String> contents, List<String> installed)
                    throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method m = VFSUtils.class.getDeclaredMethod("removedFromPluginPackages", Path.class, List.class, List.class, List.class);
        m.setAccessible(true);
        return (boolean) m.invoke(VFSUtils.class, venvDir, packages, contents, installed);
    }
    ...
    private static void createVenv(Path venvDir, String graalPyVersion, TestLog log, Path requirements, String... packages) throws IOException {
        EmbeddingTestUtils.createVenv(venvDir, graalPyVersion, log, requirements, INCONSISTENT_PKGS_ERROR, WRONG_PKG_VERSION_ERROR, MISSING_REQUIREMENTS_FILE_WARNING, PACKAGES_CHANGED_ERROR,
                        packages);
    }

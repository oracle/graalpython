...
public class VFSUtilsTest {
    ...
    @Test
    public void invalidVersionFormatTest() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        TestLog log = new TestLog();
    ...
    private static void checkWrongPkgVersionFormat(String pkg, TestLog log) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {

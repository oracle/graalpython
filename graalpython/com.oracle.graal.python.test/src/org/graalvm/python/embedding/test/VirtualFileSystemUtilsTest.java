...
public class VirtualFileSystemUtilsTest {
    ...
    private FileSystem getDelegatingFS(VirtualFileSystem utilsVfs) throws NoSuchFieldException, IllegalAccessException {
        Field f = utilsVfs.getClass().getDeclaredField("delegate");
        f.setAccessible(true);
        Object vfs = f.get(utilsVfs);
        f = vfs.getClass().getDeclaredField("impl");
        f.setAccessible(true);
    ...
    public VirtualFileSystemUtilsTest() {
    ...
    public void parseStringPath() throws Exception {
        parsePath(VirtualFileSystemUtilsTest::parseStringPath);
    }

    @Test
    public void parseURIPath() throws Exception {
        parsePath(VirtualFileSystemUtilsTest::parseURIPath);

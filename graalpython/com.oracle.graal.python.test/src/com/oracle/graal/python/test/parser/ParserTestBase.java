...
public class ParserTestBase {
    ...
    /**
     * When the tree is generated by old parser (the golden file doesn't exist),
     * then the lines that have wrong text (the old parser has some issues) are 
    ...
    /**
     * Return basically the oldTT with corrected lines, that are wrongly generated 
     * with the old parser. 

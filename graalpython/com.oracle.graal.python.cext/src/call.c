...
#else // GraalPy change
    return GraalPyPrivate_Object_Call1(func, NULL, NULL, 0);
#endif // GraalPy change
}
...
PyObject_Call(PyObject *callable, PyObject *args, PyObject *kwargs)
{
    ...
    return GraalPyPrivate_Object_Call1(callable, args, kwargs, 0);
}
...
{
    // GraalPy change: different implementation
    return GraalPyPrivate_Object_Call1(callable, args, NULL, 0);
}
...
PyObject_CallFunction(PyObject *callable, const char *format, ...)
{
    ...
    if (format == NULL || format[0] == '\0') {
        return GraalPyPrivate_Object_Call1(callable, NULL, NULL, 0);
    }
    va_list va;
    va_start(va, format);
    ...
    return GraalPyPrivate_Object_Call1(callable, args, NULL, is_single_arg(format));
}
...
PyObject_CallMethod(PyObject *obj, const char *name, const char *format, ...)
{
    ...
    PyObject* args;
    if (format == NULL || format[0] == '\0') {
        return GraalPyPrivate_Object_CallMethod1(obj, name, NULL, 0);
    }
    va_list va;
    va_start(va, format);
    args = Py_VaBuildValue(format, va);
    va_end(va);
    return GraalPyPrivate_Object_CallMethod1(obj, name, args, is_single_arg(format));
}

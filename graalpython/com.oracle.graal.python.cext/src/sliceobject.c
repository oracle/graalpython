               ...
               Py_ssize_t *start, Py_ssize_t *stop, Py_ssize_t *step)
{
    ...
    PyObject* rstep = GraalPyPrivate_GET_PySliceObject_step(r);
    if (rstep == Py_None) {
        *step = 1;
    }
    else {
    ...
    PyObject* rstart =  GraalPyPrivate_GET_PySliceObject_start(r);
    if (rstart == Py_None) {
    ...
    PyObject* rstop = GraalPyPrivate_GET_PySliceObject_stop(r);
    if (rstop == Py_None) {
...
slice_dealloc(PySliceObject *r)
{
    ...
    GraalPyPrivate_Object_GC_Del(r);
}
...
PyObject* PySlice_Start(PySliceObject *slice) {
    return GraalPyPrivate_GET_PySliceObject_start(slice);
}

PyObject* PySlice_Stop(PySliceObject *slice) {
    return GraalPyPrivate_GET_PySliceObject_stop(slice);
}

PyObject* PySlice_Step(PySliceObject *slice) {
    return GraalPyPrivate_GET_PySliceObject_step(slice);
}

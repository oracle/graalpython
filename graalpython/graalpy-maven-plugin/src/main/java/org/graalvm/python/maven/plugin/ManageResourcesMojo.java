...
public class ManageResourcesMojo extends AbstractGraalPyMojo {
    ...
    private void manageVenv() throws MojoExecutionException {
        ...
        try {
            VFSUtils.createVenv(venvDirectory, packages, requirements, INCONSISTENT_PACKAGES_ERROR, WRONG_PACKAGE_VERSION_FORMAT_ERROR, MISSING_REQUIREMENTS_FILE_WARNING, PACKAGES_LIST_CHANGED_ERROR, createLauncher(), getGraalPyVersion(project), log);
        } catch (IOException e) {

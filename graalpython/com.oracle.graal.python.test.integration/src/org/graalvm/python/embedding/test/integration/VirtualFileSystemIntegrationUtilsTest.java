...
public class VirtualFileSystemIntegrationUtilsTest {
    ...
    public VirtualFileSystemIntegrationUtilsTest() {
    ...
    public void mountPoints() throws IOException {
        ...
        VirtualFileSystem vfs = VirtualFileSystem.newBuilder().//
                        ...
                        resourceLoadingClass(VirtualFileSystemIntegrationUtilsTest.class).build();
    ...
    public Context createContext(Function<VirtualFileSystem.Builder, VirtualFileSystem.Builder> vfsBuilderFunction, Function<Builder, Builder> ctxBuilderFunction) {
        VirtualFileSystem.Builder builder = VirtualFileSystem.newBuilder().//
                        ...
                        resourceLoadingClass(VirtualFileSystemIntegrationUtilsTest.class);
        if (vfsBuilderFunction != null) {
            builder = vfsBuilderFunction.apply(builder);
        }
        VirtualFileSystem fs = builder.build();
        Builder ctxBuilder = addTestOptions(GraalPyResources.contextBuilder(fs));
    ...
    public void externalResourcesBuilderTest() throws IOException {
        ...
        try (VirtualFileSystem fs = VirtualFileSystem.newBuilder().resourceLoadingClass(VirtualFileSystemIntegrationUtilsTest.class).build()) {
            // extract VFS
            GraalPyResources.extractVirtualFileSystemResources(fs, resourcesDir);
        }
        // check extracted contents
        InputStream stream = VirtualFileSystemIntegrationUtilsTest.class.getResourceAsStream("/org.graalvm.python.vfs/fileslist.txt");

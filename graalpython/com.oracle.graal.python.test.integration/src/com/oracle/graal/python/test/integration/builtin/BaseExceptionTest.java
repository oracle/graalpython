...
public class BaseExceptionTest {
    ...
    @Test
    public void testUnhashableType() {
        String source = "try:\n" +
                        "    hash([1,2,3])\n" +
                        "except TypeError as e:\n" +
                        "    print(str(e))\n";
        PythonTests.assertPrints("unhashable type: 'list'\n", source);
    }
    ...
    @Test
    public void testNoDictAttribute() {
        String source = "try:\n" +
                        "    int(3).__dict__\n" +
                        "except AttributeError as e:\n" +
                        "    print(str(e))\n";
        PythonTests.assertPrints("'int' object has no attribute '__dict__'\n", source);
    }

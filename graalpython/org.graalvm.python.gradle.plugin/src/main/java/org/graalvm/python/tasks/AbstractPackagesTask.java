...
public abstract class AbstractPackagesTask extends DefaultTask {
    ...
    protected static final String MISSING_LOCK_FILE_WARNING = """
        ...
        WARNING: It is highly recommended to lock python dependencies by running the gradle task 'graalpyLockPackages'.
    ...
    protected static final String WRONG_PACKAGE_VERSION_FORMAT_ERROR = """
        ...
        When using the graalpy-gradle-plugin together with graalpy.lock file, it is necessary to declare python packages in format [package_name]==[version].
